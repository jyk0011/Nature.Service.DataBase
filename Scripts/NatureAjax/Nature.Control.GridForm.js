...
Nature.Controls.GridForm = function (info) {
    ...
    gridFormInfo.dataSource = info.gridView.grid.gridEvent.dataSet.data; /*记录集*/

    gridFormInfo.form = {}, /*对应的表单控件，内部生成*/

    gridFormInfo.formPageViewID = 0;//修改数据使用的视图ID
...
Nature.Controls.GridForm.prototype.onPager = function () {
    ...
    self.gridFormInfo.dataSource = self.gridFormInfo.grid.gridEvent.dataSet.data;
...
Nature.Controls.GridForm.prototype.setTrClick = function (tr) {
    ...
    tr.dblclick(function () {
        ...
        if (self.gridFormInfo.window.isEditing) /*是否在编辑状态，在编辑状态则不执行*/
            return;

        self.gridFormInfo.window.isEditing = true;
        
        self.gridFormInfo.rowIndex = tr.attr("index"); /*单击了第几行*/
        self.gridFormInfo.window.editDataId = self.gridFormInfo.dataSource[self.gridFormInfo.rowIndex]._id;
...
Nature.Controls.GridForm.prototype.setSave = function () {
    ...
    self.gridFormInfo.btnSave.click(function (e) { /*保存操作*/
        /*不冒泡*/
        e.stopPropagation();
        self.gridFormInfo.window.isEditing = false;
...
Nature.Controls.GridForm.prototype.bindForm = function() {
    ...
    var formEvent = {
        ...
        masterPageViewID: self.gridFormInfo.formPageViewID,
        findPageViewID: 0,
        buttonId: self.gridFormInfo.buttonId,
        dataID: 0,
        foreignID: "-2",
        window: self.gridFormInfo.window,
        isBatch:true,
    ...
    self.gridFormInfo.form = new Nature.Controls.Form(formEvent, { dataBaseId: self.gridFormInfo.dataBaseId }, self.para);
